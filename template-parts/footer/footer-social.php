    ...
    <a href="<?php echo esc_url($linkedin_url); ?>" class="social-link social-linkedin" target="_blank"
        ...
        <svg width="25" height="25" viewBox="0 0 21 21" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path
                ...
                stroke="#0e4194" stroke-opacity="0.6" stroke-linecap="round" stroke-linejoin="round" />
            <path d="M5.25 7.875H1.75V18.375H5.25V7.875Z" stroke="#0e4194" stroke-opacity="0.6" stroke-linecap="round"
