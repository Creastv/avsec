...
<div class="footer-brand">
    ...
    <div class="footer-contact">
        <div class="footer-contact-address">
            ...
            $footer_address = avsec_get_theme_mod('footer_address', '');
            ?>
            <?php if ($footer_address) : ?>
                <div class="contact-item">
                    ...
                    <?php
                    $footer_address_url = avsec_get_theme_mod('footer_address_url', '');
        ...
        <?php
        $contact_button_text = avsec_get_theme_mod('contact_button_text', __('Contact Us', 'avsec'));
        $contact_button_url = avsec_get_theme_mod('contact_button_url', '#');
